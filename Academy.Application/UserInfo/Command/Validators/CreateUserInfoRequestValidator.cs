...
{
    public class CreateUserInfoRequestValidator : CustomValidator<CreateUserInfoRequest>
    {
        public CreateUserInfoRequestValidator(IRepository<Entities.UserInfo> repository)
        {
