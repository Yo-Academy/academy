...
namespace Academy.Application.Dashboard.Query.Handlers
{
    public class GetDashboardListRequestHandler : IRequestHandler<GetDashboardListRequest, Result<List<DashboardDto>>>
    {
        ...
        public GetDashboardListRequestHandler(IReadRepository<Entity.Academies> repository, IDashboardRepository dashboardRepository)
        {
        ...
        public async Task<Result<List<DashboardDto>>> Handle(GetDashboardListRequest request, CancellationToken cancellationToken)
        {
            ...
            var data = _dashboardRepository.GetList(request);
            return Result.Succeed(data.ToList());
            ...
            //        ActiveMembers = 2,
            //        ActiveUsers = 3,
            //        Image = "C:\\Users\\me\\Downloads\\Cricket.png",
            //        Users = 2
            //    },
            //    new DashboardDto
            //    {
            ...
            //        ActiveMembers = 2,
            //        ActiveUsers = 3,
            //        Image = "C:\\Users\\me\\Downloads\\Football.png",
            //        Users = 2
            //    },
            //    new DashboardDto
            //    {
            ...
            //        ActiveMembers = 2,
            //        ActiveUsers = 3,
            //        Image = "C:\\Users\\me\\Downloads\\Tennis.png",
            //        Users = 2
            //    },
            //    new DashboardDto
            //    {
            ...
            //        ActiveMembers = 2,
            //        ActiveUsers = 3,
            //        Image = "C:\\Users\\me\\Downloads\\Badminton.png",
            //        Users = 2
            //    }
            // };
