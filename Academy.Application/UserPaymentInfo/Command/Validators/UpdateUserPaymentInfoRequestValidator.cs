...
{
    public class UpdateUserPaymentInfoRequestValidator : CustomValidator<UpdateUserPaymentInfoRequest>
    {
        public UpdateUserPaymentInfoRequestValidator(IRepository<Entities.UserPaymentInfo> repository)
        {
