...
namespace Academy.Application.Common.Storage
{
    ...
    public interface IStorage
    {
        ...
        /// <summary>
        ///     Sets lock on a file to avoid write operation and deletion on that file
        /// </summary>
        ...
        /// <summary>
        ///     Checks whether the file has been locked
        /// </summary>
        ...
        /// <summary>
        ///     Returns the presigned url from the blob storage
        /// </summary>
