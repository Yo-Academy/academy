...
namespace Academy.Migrators.PostgreSQL.Migrations.Application
{
    ...
    [Migration("20241120170515_add_UserPaymentInfo")]
    partial class add_UserPaymentInfo
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Academy.Domain.Entities.PaymentType", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Academy.Domain.Entities.UserPaymentInfo", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Academy.Domain.Entities.UserPaymentInfo", b =>
                {
                    b.HasOne("Academy.Domain.Entities.PaymentType", "PaymentType")
                        .WithMany()
                        .HasForeignKey("PaymentTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Academy.Domain.Entities.UserInfo", "UserInfo")
                        .WithMany()
