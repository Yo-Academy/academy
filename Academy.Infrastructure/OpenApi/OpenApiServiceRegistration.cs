...
using Westwind.Globalization.Administration;
using WestWind.Globalization.AspNetCore.Controllers;
using ZymLabs.NSwag.FluentValidation;

namespace Academy.Infrastructure.OpenApi
{
    internal static class OpenApiServiceRegistration
    {
        internal static IServiceCollection AddOpenApiDocumentation(this IServiceCollection services, IConfiguration config)
        {
            ...
            if (settings.Enable)
            {
                ...
                _ = services.AddOpenApiDocument((document, serviceProvider) =>
                {
                    ...
                    document.OperationProcessors.Add(new ExcludControllerOperationProcessor());
        ...
        public class ExcludControllerOperationProcessor : IOperationProcessor
        {
            private readonly HashSet<Type> ExcludedController = new HashSet<Type>
            {
                typeof(JavaScriptLocalizationResourcesController),
                typeof(LocalizationAdministrationController)
            };
            public bool Process(OperationProcessorContext context)
            {
                return !ExcludedController.Contains(context.ControllerType);
            }
        }
    }
}
