...
{
    public class TenantInfo : ITenantInfo, IAuditableEntity
    {
        ...
        public TenantInfo(string id, string name, string? connectionString, string adminEmail, IConfiguration config, string? issuer = null)
        {
            Id = id;
            Identifier = id;
            Name = name;
        ...
        {
            if (Id == _config.GetSection(nameof(DefaultTenantSettings)).Get<DefaultTenantSettings>()!.Id)
            {
